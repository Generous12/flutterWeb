...
class ComponenteServiceAtributo {
  final String url =
      "http://172.25.10.207/proyecto_web/backend/procedimientoAlm/atributosComponente/listarcomponenAtri.php";
  final String urlCrud =
      "http://172.25.10.207/proyecto_web/backend/procedimientoAlm/atributosComponente/crudAtri.php";
