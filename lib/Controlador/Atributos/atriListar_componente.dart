...
class ComponenteServiceAtributo {
  final String url =
      "http://192.168.18.22/proyecto_web/backend/procedimientoAlm/atributosComponente/listarcomponenAtri.php";
  final String urlCrud =
      "http://192.168.18.22/proyecto_web/backend/procedimientoAlm/atributosComponente/crudAtri.php";
